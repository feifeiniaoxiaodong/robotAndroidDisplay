...
public class FindLocalMusicUrl {
    ...
    public   static  String searchLocalMusic(Context context,String musicdesc){
      ...
      File file= new File(context.getResources().getString(R.string.musicrootpath));  //机器人地址
//        File file= new File(context.getResources().getString(R.string.weiphone));  //手机地址
