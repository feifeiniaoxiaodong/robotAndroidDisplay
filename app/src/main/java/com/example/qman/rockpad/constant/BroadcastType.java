package com.example.qman.rockpad.constant;
...
public class BroadcastType {
    public final static String SCANBAR = "bar";
    public final static String SCAN2BAR = "2Dbar";
    ...
    public final static String ROBOTINFO_TEMPERATURE = "temperature";
    public final static String ROBOTINFO_SMOKE = "smoke";
